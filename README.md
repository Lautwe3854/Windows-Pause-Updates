...
6. Double-click the main Windows file to run it
7. If Windows shows a security prompt, choose Run or More info, then Run anyway
8. Follow the on-screen steps inside the tool
...
2. Extract it
3. Open the folder
4. Run the file inside

If you see a batch file:
1. Download it
2. Right-click it if needed
3. Choose Run as administrator if the tool asks for it
...
4. Run the main file
5. Follow the menu inside the tool
...
batch-script, batch-utility, privacy-hardening, regedit, registry-scripts, system-tools, win11-tweaks, windows-10, windows-11, windows-debloat, windows-optimization, windows-privacy, windows-privacy-tool, windows-recall, windows-services, windows-telemetry, windows-tweaks, windows-update, windows-update-blocker, windows-updates